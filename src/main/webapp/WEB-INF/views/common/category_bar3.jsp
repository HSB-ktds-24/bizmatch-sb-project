...
<html>
  <head>
    ...
    <link rel="stylesheet" href="/css/category_bar.css" />
  ...
  <body>
    <div class="select_box">
      <!--
      임시방편으로  name값에 cmpnyBizCtgry 부여했으나 원래 값은 cmpnyIndstrId
      cmpnyBizCtgry 유형 선택할 때 부여가 되어야 함
      -->
      <select id="intrstdIndstrId" name="mjrId" class="level-category">
    ...
    <div class="select_box">
      ...
      중분류는 어떤 name값?
      -->
      <select id="intrstdIndstrId" name="smjrId" class="second-level-category">
        <option value="option0">중분류</option>
